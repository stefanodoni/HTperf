...
# MAX_THROUGHPUT = 2000 # Rubbos 5500 load higher throughput
# MAX_THROUGHPUT = 150 # CBench Throughput 10ms
# MAX_THROUGHPUT = 400 # CBench Throughput 1ms
# MAX_THROUGHPUT = 160000 # SPECpower Throughput laptop
# MAX_THROUGHPUT = 220000 # SPECpower Throughput fisso
